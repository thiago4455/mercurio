...
<body>
    ...
    <div id="fast-search">
        ...
        <div id="busca">
            <input type="text" id="inputSearch" placeholder="Pesquise Código, Nome, CPF, Email ou Telefone" autocomplete="off">
        </div>
    </div>

    <div id="fast-actions">
        <button id="btn-modal-cadastrar" type="button" class="btn btn-success" data-toggle="modal" data-target=".modal-cadastrar" <?php echo $_SESSION['tipoLog']!='admin'?'disabled':'';?>>Cadastrar Novo Funcionário</button>
    </div>
